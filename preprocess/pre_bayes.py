...
def make_dataset(input_file,
    ...
    :return:
    """
    print('`BayesModel` making dataset...')
...
if __name__ == '__main__':
    # 生成数据集
    corpus_file = '../data/bayes/corpus.txt'
    train_file = '../data/bayes/train.txt'
    test_file = '../data/bayes/test.txt'
    make_dataset(corpus_file, train_file, test_file)
